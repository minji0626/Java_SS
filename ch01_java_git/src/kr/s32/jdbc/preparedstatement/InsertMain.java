...
public class InsertMain {
	public static void main(String[] args) {
			...
			try {
				...
				sql = "INSERT INTO test2 (id, name, age, rec_date) VALUES(?,?,?,SYSDATE)";
				//JDBC 수행 3단계 : PreparedStatement 객체 생성
				pstmt = conn.prepareStatement(sql);
				// ? 에 데이터를 바인딩 
				pstmt.setString(1, "star"); // SQL문의 1번 물음표에 "star" 데이터를 삽입
				pstmt.setString(2, "홍길동"); // SQL문의 2번 물음표에 "홍길동" 데이터를 삽입
				pstmt.setInt(3, 20); //SQL문의 3번 물음표에 20 데이터를 삽입
